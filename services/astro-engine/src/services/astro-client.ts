...
export class AstroEngineClient {
  ...
  async getYoga(data: BirthData, yogaType: string): Promise<any> {
    ...
    const endpointMap: Record<string, string> = {
      ...
      // Jaimini Yogas
      chara_karakas_raja: "chara_karakas_raja",
      arudha_lagna_raja: "arudha_lagna_raja",
      swamsa_raja: "swamsa_raja",
      hora_lagna_dhana: "hora_lagna_dhana",
      jaimini_wealth: "jaimini-wealth-indicator",
      karakamsa_arishta: "karakamsa-arishta",
      jaimini_maraka: "calculate_jaimini_maraka",
      arista_sutra: "arista-sutra-special",
      jaimini_gajakesari: "calculate_jaimini_gajakesari",
      amala: "calculate-amala-yoga",
      parvata: "calculate_parvata_yoga",
      kahala: "calculate_kahala",
      vasumati: "calculate_vasumati_yoga",
      kartari: "calculate_kartari",
      jaimini_combination: "jaimini_yogas_combination",
      jaimini_argala: "jaimini-argala-yoga",
      jaimini_argala_position: "calculate_jaimini_argala_position",
      virodha_argala: "virodha-argala",
      relationship_upapada: "relationship-upapada-yogas",
      jaimini_navamsa: "calculate_jaimini_navamsa",
      karakamsa_spiritual: "calculate_karakamsa_spiritual",
      jaimini_spiritual: "calculate_jaimini_spiritual_yogas",
      bk_yogas: "calculate_bk_yogas",
      jaimini_mk: "calculate_jaimini_mk_yogas",
      putrakaraka: "calculate_putrakaraka_yogas",
      gk_yogas: "calculate_gk_yogas",
      jaimini_other: "calculate_jaimini_other_combinations",

      // Tajika Yogas
      duphali_kutta: "calculate_Duphali-Kutta-Yoga",
      iqabala: "calculate_iqabala_image_logic",
      induvara: "calculate_induvara_yoga",
      ithasala: "tajika_ithasala_yoga",
      esharpha: "calculate_esharpha_yoga",
      nakata: "calculate_nakata_yoga",
      yamaya: "calculate_yamaya_yoga",
      manau: "calculate_manau_yoga",
      kamboola: "calculate_kamboola_yoga",
      gairi_kamboola: "gairi_kamboola_yoga",
      khallasara: "calculate_khallasara_yoga",
      radda: "tajika_radda_yoga",
      dutthotta_daivira: "dutthotta_daivira_yoga",
      tambira: "tambira_yoga",
      kuttha: "tajika_kuttha_yoga",
      durupha: "calculate_durupha",
    };
