...
export const LAHIRI_ENDPOINTS = {
  ...
  CHARA_KARAKAS_RAJA: "/lahiri/chara_karakas_raja",
  ARUDHA_LAGNA_RAJA: "/lahiri/arudha_lagna_raja",
  SWAMSA_RAJA: "/lahiri/swamsa_raja",
  HORA_LAGNA_DHANA: "/lahiri/hora_lagna_dhana",
  JAIMINI_WEALTH_INDICATOR: "/lahiri/jaimini-wealth-indicator",
  KARAKAMSA_ARISHTA: "/lahiri/karakamsa-arishta",
  JAIMINI_MARAKA: "/lahiri/calculate_jaimini_maraka",
  ARISTA_SUTRA_SPECIAL: "/lahiri/arista-sutra-special",
  JAIMINI_GAJAKESARI: "/lahiri/calculate_jaimini_gajakesari",
  AMALA_YOGA: "/lahiri/calculate-amala-yoga",
  PARVATA_YOGA: "/lahiri/calculate_parvata_yoga",
  KAHALA_YOGA: "/lahiri/calculate_kahala",
  VASUMATI_YOGA: "/lahiri/calculate_vasumati_yoga",
  KARTARI_YOGA: "/lahiri/calculate_kartari",
  JAIMINI_YOGAS_COMBINATION: "/lahiri/jaimini_yogas_combination",
  JAIMINI_ARGALA_YOGA: "/lahiri/jaimini-argala-yoga",
  JAIMINI_ARGALA_POSITION: "/lahiri/calculate_jaimini_argala_position",
  VIRODHA_ARGALA: "/lahiri/virodha-argala",
  RELATIONSHIP_UPAPADA_YOGAS: "/lahiri/relationship-upapada-yogas",
  JAIMINI_NAVAMSA: "/lahiri/calculate_jaimini_navamsa",
  KARAKAMSA_SPIRITUAL: "/lahiri/calculate_karakamsa_spiritual",
  JAIMINI_SPIRITUAL_YOGAS: "/lahiri/calculate_jaimini_spiritual_yogas",
  BK_YOGAS: "/lahiri/calculate_bk_yogas",
  JAIMINI_MK_YOGAS: "/lahiri/calculate_jaimini_mk_yogas",
  PUTRAKARAKA_YOGAS: "/lahiri/calculate_putrakaraka_yogas",
  GK_YOGAS: "/lahiri/calculate_gk_yogas",
  JAIMINI_OTHER_COMBINATIONS: "/lahiri/calculate_jaimini_other_combinations",

  // Tajika Yogas (16 endpoints)
  DUPHALI_KUTTA_YOGA: "/lahiri/calculate_Duphali-Kutta-Yoga",
  IQABALA_YOGA: "/lahiri/calculate_iqabala_image_logic",
  INDUVARA_YOGA: "/lahiri/calculate_induvara_yoga",
  ITHASALA_YOGA: "/lahiri/tajika_ithasala_yoga",
  ESHARPHA_YOGA: "/lahiri/calculate_esharpha_yoga",
  NAKATA_YOGA: "/lahiri/calculate_nakata_yoga",
  YAMAYA_YOGA: "/lahiri/calculate_yamaya_yoga",
  MANAU_YOGA: "/lahiri/calculate_manau_yoga",
  KAMBOOLA_YOGA: "/lahiri/calculate_kamboola_yoga",
  GAIRI_KAMBOOLA_YOGA: "/lahiri/gairi_kamboola_yoga",
  KHALLASARA_YOGA: "/lahiri/calculate_khallasara_yoga",
  RADDA_YOGA: "/lahiri/tajika_radda_yoga",
  DUTTHOTTA_DAIVIRA_YOGA: "/lahiri/dutthotta_daivira_yoga",
  TAMBIRA_YOGA: "/lahiri/tambira_yoga",
  KUTTHA_YOGA: "/lahiri/tajika_kuttha_yoga",
  DURUPHA_YOGA: "/lahiri/calculate_durupha",
