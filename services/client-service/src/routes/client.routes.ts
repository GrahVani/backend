...
router.get("/:id/yoga/:yogaType", chartController.getYogaAnalysis.bind(chartController));
router.get("/:id/dosha/:doshaType", chartController.getDoshaAnalysis.bind(chartController));
...
router.get("/:id/yoga-dosha-summary", chartController.getYogaDoshaSummary.bind(chartController));
...
router.post("/:id/kp/interlinks", chartController.getKpInterlinks.bind(chartController));
router.post(
  "/:id/kp/interlinks-advanced",
  chartController.getKpAdvancedInterlinks.bind(chartController),
);
router.post("/:id/kp/nakshatra-nadi", chartController.getKpNakshatraNadi.bind(chartController));
router.post("/:id/kp/fortuna", chartController.getKpFortuna.bind(chartController));
