...
class AstroEngineClient {
  ...
  async getPranaDasha(birthData: BirthData, ayanamsa: Ayanamsa = "lahiri"): Promise<AstroResponse> {
    switch (ayanamsa) {
      ...
      case "kp":
        ...
        return (
          await this.internalClient.post("/dasha/prana", {
            ...birthData,
            ayanamsa: "kp",
          })
        ).data;
  ...
  async getKpHorary(
    birthData: BirthData & { horaryNumber: number; question: string },
  ): Promise<AstroResponse> {
