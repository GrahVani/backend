...
export type UserLogoutEvent = BaseEvent<
  "user.logout",
  {
    userId: string;
    sessionId: string;
...
export type EmailVerifiedEvent = BaseEvent<
  "auth.email_verified",
  {
    userId: string;
    email: string;
...
export type BookingCreatedEvent = BaseEvent<
  "booking.created",
  {
    bookingId: string;
    clientId: string;
...
export type BookingCancelledEvent = BaseEvent<
  "booking.cancelled",
  {
    bookingId: string;
    clientId: string;
...
export type BookingCompletedEvent = BaseEvent<
  "booking.completed",
  {
    bookingId: string;
    clientId: string;
...
export type PaymentInitiatedEvent = BaseEvent<
  "payment.initiated",
  {
    paymentId: string;
    orderId: string;
...
export type RefundInitiatedEvent = BaseEvent<
  "refund.initiated",
  {
    refundId: string;
    paymentId: string;
